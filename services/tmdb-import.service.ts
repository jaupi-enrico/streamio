...
// and reads plain fields off the response, rather than building a full
// `Movie`/`TvShow` and picking it apart again: those constructors take
// eighteen positional arguments, and all this wants is a handful of values.
