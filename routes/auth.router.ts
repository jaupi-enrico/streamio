...
export function createAuthRouter(db: Database, redis: Redis): Router {
  ...
  // whatever public URL the server had when it was sent, and on an install
  // whose hostname moves that host can already be dead — so a user can end up
  // holding a dead link having done nothing wrong.
